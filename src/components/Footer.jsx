    ...
    return (
        <div>
            <footer className="px-4 divide-y dark:bg-gray-100 dark:text-gray-800">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            <span className="self-center text-2xl font-semibold">CulinaryCanvas</span>
                        </a>
                    </div>

                    <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                        <div className="space-y-3">
                            <h3 className="tracking-wide uppercase dark:text-gray-900">Visit</h3>
                        ...
                        <div className="space-y-3">
                            ...
                            <ul className="space-y-1">
                                <li>
                                    <a rel="noopener noreferrer" href="#">Phone: 0123456789</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#">Email: rnrabi@gmail.com</a>
                                </li>
                            </ul>
                        </div>
                ...
                <div className="py-6 text-sm text-center dark:text-gray-600">© 2024 ColinaryCanvas All rights reserved.</div>
            </footer>
        </div>
    );
};
