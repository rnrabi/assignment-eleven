        ...
        <div>
            <section className="py-6 dark:bg-gray-100 dark:text-gray-800">
                <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
                    ...
                    <h1 className="text-4xl font-bold leading-none text-center sm:text-5xl">Our Food Services Team</h1>
                    <div className="flex flex-row flex-wrap-reverse justify-center mt-8">

                        {
                            foodServices.map((food ,idx)=>  <div
                            key={idx}
                            ...
                            <img alt="" className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-gray-500" src={food.image} />
                            <div className="flex-1 my-4">
                                <p className="text-xl font-semibold leading-snug">{food.supplyer}</p>
                                <p>{food.email}</p>
                            </div>
...
export default FoodServecesTeam;