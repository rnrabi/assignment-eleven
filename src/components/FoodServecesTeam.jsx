                ...
                <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
                    ...
                    <div className="flex flex-row flex-wrap-reverse justify-center mt-8">

                        {
                            ...
                            <img alt="" className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-gray-500" src={food.photo} />
                            <div className="flex-1 my-4">
                                <p className="text-xl font-semibold leading-snug">{food.name}</p>
                                <p>{food.email}</p>
                            </div>
